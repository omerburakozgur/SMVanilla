...
NDiplomacy = {
	...
	MAX_ASKED_TRADE_POWER = 50, --moon			-- Maximum % of someone's trade power can be asked for with the diplomatic action
	...
	COUNTERESPIONAGE_NETWORK_IMPACT = -0.33, --cara
	BUILD_SPY_DISCOVERED_PENALTY = -10.0,
	BUILD_SPY_NETWORK_SPEED = 1.5, --cara
	SPY_NETWORK_DECAY = 1,
	...
	SLANDER_MERCHANTS_COST = 100, --cara
	...
	PEACE_COST_GOLD_STEP = 5, 	--moon				-- _DDEF_PEACE_COST_GOLD_STEP_ Peace Cost for 1 loan size gold of giver
	...
	PEACE_COST_WAR_REPARATIONS = 10,		--moon	-- Peace cost for war reparations
...
NCountry = {
	...
	ESTATE_AGENDA_DEFAULT_MAX_ACTIVE_DAYS = 7300, --cara -- Default max amount of days an agenda can stay active
	...
	LIBERTY_DESIRE_DIPLO_TECH = 0,					-- Liberty desire per point of diplo tech more than overlord
	...
	LIBERTY_DESIRE_ROYAL_MARRIAGE = -10,				-- Liberty desire from having RM with overlord
	...
	RAZE_PROVINCE_DEVELOPMENT_DECREASE = 0,
	...
	DEBT_LIMIT_DIP = -100,							-- This is how far you can go into debt on DIP for actions that allow spending power you don't have.
...
NMilitary = {
	SLACKEN_AP_DROP = 0.05, --MOON
	SLACKEN_MANPOWER_INCREASE = 1.0, --MOON
	...
	GARRISON_SIZE = 1000, 	--moon					-- GARRISON_SIZE
	SIEGE_FORCE_NEEDED_MULTIPLIER = 3, --moon		-- x times garrison to be able to siege.
	MAX_BREACH = 3,
	...
	TRANSPORT_SHIP_SAILORS_COST = 10,				-- 1 = 1 men in cost.
	...
	FORTRESS_COST = 0.25,	--moon test edicem		-- base fort cost
	...
	BACK_LINE_MORALE_DAMAGE_TAKEN_MODIFIER = 0.0, --moon	-- Multiplier for morale damage taken by backrow
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.4, --moon		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
...
NGovernment = {
	...
	GOVERNMENT_REFORM_CHANGE_PROGRESS_COST = 25.0, --moon
