...
NDiplomacy = {
	...
	COUNTERESPIONAGE_NETWORK_IMPACT = -0.5, --cara
...
NMilitary = {
	...
	GARRISON_SIZE = 3000, 	--cara					-- GARRISON_SIZE
	SIEGE_FORCE_NEEDED_MULTIPLIER = 0.334, --moon				-- x times garrison to be able to siege.
	MAX_BREACH = 3,
